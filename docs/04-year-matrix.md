...
This MVP implements The Year Map v1 year matrix formulas in `/src/calculateYearMatrix.ts` and mirrors the formula registry in `/data/year-matrix-formulas.json`.
